        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body" id="form-order">
                    <h2 class="title">Sender Information</h2>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sender_province">
                                    <input class="form-control hid" type="text" name="sender_provinsi">
                                    <style type="text/css"> .hid{ display: none; visibility: hidden;}</style>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sender_city">
                                    <input class="form-control hid" type="text" name="sender_kota">
                                    <style type="text/css"> .hid{ display: none; visibility: hidden;}</style>
                                    </select>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="sender_subdistrict">
                                    <!-- <select class="form-control" name="sender_subdistrict"> -->
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="sender_postalcode">
                                </div>
                            </div>
                        </div></br></br>
                    ...
                    <form method="POST" id="order-form">
                            <div class="row row-space">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control hid" type="text" name="receiver_provinsi">
                                        <style type="text/css"> .hid{ display: none; visibility: hidden;}</style>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control hid" type="text" name="receiver_kota">
                                        <style type="text/css"> .hid{ display: none; visibility: hidden;}</style>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label class="label">Kecamatan</label>
                                        <input class="form-control" type="text" name="receiver_subdistrict">
                                        <!-- <select class="form-control" name="receiver_subdistrict"> -->
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-space">
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        <label class="label">Kode Pos</label>
                                        <input class="form-control" type="text" name="receiver_postalcode">
                                    </div>
                                </div>
                            </div></br></br>
                            ...
                            <form method="POST" id="order-form">
                                <div class="row row-space">
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="item_weight" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row row-space">
                                ...
                                <div class="row row-space">
                                    <!-- <div class="col-2">
                                        <div class="form-group">
                                            <label class="label">Tipe Pengiriman</label>
                                            <select class="form-control" name="tipe_ekspedisi">
                                            </select>
                                        </div>
                                    </div> -->
                                    <!-- <div class="col-2">
                                        <div class="form-group">
                                            <label class="label">Tipe Paket</label>
                                ...
                                <div class="row row-space">
                                    <div class="">
                                        <div class="form-group">
                                            <label class="label">Biaya Pengiriman Total</label>
                                            <input class="form-control" type="text" name="cost" value="10000">
                                        </div>
                                    </div></br>
                                </div>
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--red" type="hapus">HAPUS</button>
